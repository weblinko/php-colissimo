...
/**
 * This class stands for GenerateCN23RequestType StructType
 * @subpackage Structs
 */
class GenerateCN23RequestType extends AbstractStructBase
{
    /**
     * The contractNumber
     * @var string
     ...
     * @uses GenerateCN23RequestType::setContractNumber()
     * @uses GenerateCN23RequestType::setPassword()
     * @uses GenerateCN23RequestType::setLetter()
     * @uses GenerateCN23RequestType::setFields()
     ...
     * @param string $contractNumber
     * @return \Colissimo\StructType\GenerateCN23RequestType
     */
